...
searchIndex["Achievement"] = {
    ...
    "paths": []
};searchIndex["ForgeQuery"] = {
    "items": [
        [0, "", "ForgeQuery", "The result of a database query."],
        ...
        [3, "NextRow", "", "Advances the <a class=\"mod\" href=\"ForgeQuery/index.html\">ForgeQuery</a> to the next row in the result set."],
    ],
    "paths": []
    ...
    "items": [
        ...
        [3, "AuthDBQuery", "", "Executes a SQL query on the login database and returns an <a class=\"mod\" href=\"ForgeQuery/index.html\">ForgeQuery</a>."],
        [3, "AuthDBQueryAsync", "", "Executes an asynchronous SQL query on the character database and passes an <a class=\"mod\" href=\"ForgeQuery/index.html\">ForgeQuery</a> to a callback function."],
        ...
        [3, "CharDBQuery", "", "Executes a SQL query on the character database and returns an <a class=\"mod\" href=\"ForgeQuery/index.html\">ForgeQuery</a>."],
        [3, "CharDBQueryAsync", "", "Executes an asynchronous SQL query on the character database and passes an <a class=\"mod\" href=\"ForgeQuery/index.html\">ForgeQuery</a> to a callback function."],
        ...
        [3, "GetItemDisplayId", "", "Retrieves the DisplayId for a specific item entry. This method fetches the <code>DisplayId</code> for an item based on its entry ID from the <code>item_template</code> table."],
        ...
        [3, "IsCompatibilityMode", "", "Returns <code>true</code> if Forge is in compatibility mode, <code>false</code> if in multistate."],
        ...
        [3, "ReloadForge", "", "Reloads the Lua engine."],
        ...
        [3, "WorldDBQuery", "", "Executes a SQL query on the world database and returns an <a class=\"mod\" href=\"ForgeQuery/index.html\">ForgeQuery</a>."],
        [3, "WorldDBQueryAsync", "", "Executes an asynchronous SQL query on the world database and passes an <a class=\"mod\" href=\"ForgeQuery/index.html\">ForgeQuery</a> to a callback function."],
    ...
    "items": [
        ...
        [3, "GetCreatureByAreaId", "", "Gets a table of creatures in a specific area from the given map."],
        [3, "GetDifficulty", "", "Returns the difficulty of the <a class=\"mod\" href=\"Map/index.html\">Map</a>."],
        [3, "GetGameObjectByAreaId", "", "Gets a table of gameobjects in a specific area from the given map."],
    ...
    "items": [
        ...
        [3, "GetUnitByGUID", "", "Returns the <a class=\"mod\" href=\"Player/index.html\">Player</a> that is currently trading with this <a class=\"mod\" href=\"Player/index.html\">Player</a>"],
