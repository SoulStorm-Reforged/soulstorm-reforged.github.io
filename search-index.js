...
searchIndex["Aura"] = {
    ...
    "items": [
        ...
        [3, "AllLootRemoved", "", "Set all loot removed from corpse for the <a class=\"mod\" href=\"Creature/index.html\">Creature</a>"],
        ...
        [3, "GetLoot", "", "Return the <a class=\"mod\" href=\"Loot/index.html\">Loot</a> object from the <a class=\"mod\" href=\"Creature/index.html\">Creature</a>"],
    ...
    "items": [
        ...
        [3, "GetSpellInfo", "", "Get the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> of entry"],
        ...
        [3, "RegisterBattlegroundEvent", "", "Registers a <a class=\"mod\" href=\"BattleGround/index.html\">BattleGround</a> event handler."],
    ...
    "items": [
        ...
        [3, "AddItem", "", "Add an item to the <a class=\"mod\" href=\"Loot/index.html\">Loot</a> object"],
        [3, "Clear", "", "Clear the <a class=\"mod\" href=\"Loot/index.html\">Loot</a>."],
        [3, "GenerateMoney", "", "Generate random copper amount to the <a class=\"mod\" href=\"Loot/index.html\">Loot</a>."],
        [3, "GetItems", "", "Returns a table with all data from the items in the <a class=\"mod\" href=\"Loot/index.html\">Loot</a>"],
        [3, "GetMoney", "", "Returns the copper amount on the <a class=\"mod\" href=\"Loot/index.html\">Loot</a>."],
        [3, "GetUnlootedCount", "", "Returns the amount of unlooted count item of the <a class=\"mod\" href=\"Loot/index.html\">Loot</a>."],
        [3, "HasItem", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"Loot/index.html\">Loot</a> have item, <code>false</code> otherwise."],
        [3, "IsLooted", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"Loot/index.html\">Loot</a> is already looted, <code>false</code> otherwise."],
        [3, "RemoveItem", "", "Remove Item from the <a class=\"mod\" href=\"Loot/index.html\">Loot</a>. If there is no count there is delete all the specified itemid."],
        [3, "SetItemLooted", "", "Set the specified item with specified count is already looter for the <a class=\"mod\" href=\"Loot/index.html\">Loot</a>."],
        [3, "SetMoney", "", "Set the specified copper amount to the <a class=\"mod\" href=\"Loot/index.html\">Loot</a>."],
        [3, "SetUnlootedCount", "", "Set the unlooted count in <a class=\"mod\" href=\"Loot/index.html\">Loot</a>."],
        [3, "UpdateItemIndex", "", "Update the item_index for the <a class=\"mod\" href=\"Loot/index.html\">Loot</a>."],
    ],
    "paths": []
};searchIndex["Map"] = {
    "items": [
    ...
    "items": [
        ...
        [3, "GetResetTalentsCost", "", "Returns the <a class=\"mod\" href=\"Player/index.html\">Player</a>s accumulated talent reset cost"],
        ...
        [3, "GossipMenuSetText", "", "Sets the text for a specific gossip menu."],
        ...
        [3, "HasGlyph", "", "Returns bool if <a class=\"mod\" href=\"Player/index.html\">Player</a> has specified glyph"],
        ...
        [3, "SendTrainerList", "", "Sends a specified trainer window to the <a class=\"mod\" href=\"Player/index.html\">Player</a> from the <a class=\"mod\" href=\"Creature/index.html\">Creature</a> specified"],
    ...
    "items": [
        ...
        [3, "GetSpellInfo", "", "Returns the target <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> of the <a class=\"mod\" href=\"Spell/index.html\">Spell</a>."],
    ...
    "paths": []
};searchIndex["SpellEffectInfo"] = {
    "items": [
        [0, "", "SpellEffectInfo", "Inherits all methods from: none"],
        [3, "GetEffect", "", ""],
        [3, "GetMiscValue", "", ""],
        [3, "GetMiscValueB", "", ""],
    ],
    ...
    "items": [
        ...
        [3, "HasInitialAggro", "", ""],
        [3, "HasOnlyDamageEffects", "", "Checks if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> contains only damage effects."],
        ...
        [3, "IsSingleTarget", "", ""],
        [3, "IsStackableOnOneSlotWithDifferentCasters", "", "Checks if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> represents a spell or ability that can be stacked on one slot by different casters."],
    ...
    "items": [
        ...
        [3, "ApplyStatPctModifier", "", "The <a class=\"mod\" href=\"Unit/index.html\">Unit</a> set a specific Pct stat"],
        ...
        [3, "HandleStatFlatModifier", "", "The <a class=\"mod\" href=\"Unit/index.html\">Unit</a> handle a specific flat stat"],
        ...
        [3, "SetStatFlatModifier", "", "The <a class=\"mod\" href=\"Unit/index.html\">Unit</a> set a specific flat stat"],
        [3, "SetStatPctModifier", "", "The <a class=\"mod\" href=\"Unit/index.html\">Unit</a> set a specific Pct stat"],
        [3, "SetStunned", "", ""],
        [3, "SetVisible", "", ""],
